...
public @interface Module {
   ...
   * for additional static checking: tools can detect if included bindings are not necessary.
   * Modules that have unnecessary bindings must use {@code library = true}.
   */
